...
func TestBuildOpenInteractiveRequestAgentProfile(t *testing.T) {
	oi := buildOpenInteractiveRequest("/repo", SessionOpts{Selector: protocol.RunnerSelector{Kind: protocol.RunnerSelectorKind_Any}, Caps: protocol.Capability_All, AgentProfile: "codex"})
...
func TestBuildOpenInteractiveRequestAgentProfileEmpty(t *testing.T) {
	oi := buildOpenInteractiveRequest("/repo", SessionOpts{Selector: protocol.RunnerSelector{Kind: protocol.RunnerSelectorKind_Any}, Caps: protocol.Capability_All})
