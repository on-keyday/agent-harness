...
func TestTryDispatch_HappyPath(t *testing.T) {
	...
	taskID := tasks.Create("/repo", "do work", protocol.TaskKind_Oneshot, protocol.ClientKind_Unspecified, protocol.TaskID{}, "", protocol.RunnerSelector{Kind: protocol.RunnerSelectorKind_Any}, nil)
...
func TestTryDispatch_SendError(t *testing.T) {
	...
	taskID := tasks.Create("/repo", "work", protocol.TaskKind_Oneshot, protocol.ClientKind_Unspecified, protocol.TaskID{}, "", protocol.RunnerSelector{Kind: protocol.RunnerSelectorKind_Any}, nil)
	task, _ := tasks.Get(taskID)
...
func TestTryDispatch_RegistersTicket(t *testing.T) {
	...
	taskIDHex := tasks.Create("/repo", "ticket-test", protocol.TaskKind_Oneshot, protocol.ClientKind_Unspecified, protocol.TaskID{}, "", protocol.RunnerSelector{Kind: protocol.RunnerSelectorKind_Any}, nil)
