...
func TestSendAssignReachesRunner(t *testing.T) {
	...
	taskID := s.tasks.Create("/r", "do-the-thing", protocol.TaskKind_Oneshot, protocol.ClientKind_Unspecified, protocol.TaskID{}, "", protocol.RunnerSelector{}, nil)
...
func TestSweepIdleDetached_CancelsExpiredSessions(t *testing.T) {
	...
	taskID := s.tasks.Create("/r", "p", protocol.TaskKind_Interactive, protocol.ClientKind_Unspecified, protocol.TaskID{}, "", protocol.RunnerSelector{}, nil)
