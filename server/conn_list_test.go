...
func TestConnList_JoinAndRoles(t *testing.T) {
	...
	s.tasks.Create("/repo", "agent-task", protocol.TaskKind_Oneshot, protocol.ClientKind_Unspecified, protocol.TaskID{}, "", protocol.RunnerSelector{}, nil, protocol.Capability_All, Scope{}, "")
...
func TestConnList_SubtreeGating(t *testing.T) {
	...
	pHex := s.tasks.Create("/r", "p", protocol.TaskKind_Oneshot, protocol.ClientKind_Unspecified, protocol.TaskID{}, "", protocol.RunnerSelector{}, nil, protocol.Capability_All, Scope{}, "")
	copyHexToID(t, pHex, &pidTask)
	cHex := s.tasks.Create("/r", "c", protocol.TaskKind_Oneshot, protocol.ClientKind_Unspecified, pidTask, "", protocol.RunnerSelector{}, nil, protocol.Capability_None, Scope{}, "")
	copyHexToID(t, cHex, &cidTask)
	gHex := s.tasks.Create("/r", "g", protocol.TaskKind_Oneshot, protocol.ClientKind_Unspecified, cidTask, "", protocol.RunnerSelector{}, nil, protocol.Capability_None, Scope{}, "")
	copyHexToID(t, gHex, &gidTask)
	otherHex := s.tasks.Create("/r", "other", protocol.TaskKind_Oneshot, protocol.ClientKind_Unspecified, protocol.TaskID{}, "", protocol.RunnerSelector{}, nil, protocol.Capability_All, Scope{}, "")
