...
func TestResumeFromTerminal(t *testing.T) {
	...
	got, err := tasks.Resume(id, "new prompt", []string{"--B"}, protocol.RunnerSelector{Kind: protocol.RunnerSelectorKind_Any}, "runnerB", protocol.ClientKind_Unspecified, false, protocol.Capability_None, protocol.TaskKind_Oneshot, "")
	if err != nil {
...
func TestResumeRejectsNonTerminal(t *testing.T) {
	...
	t.Run("queued", func(t *testing.T) {
		...
		_, err := tasks.Resume(id, "x", nil, protocol.RunnerSelector{}, "", protocol.ClientKind_Unspecified, false, protocol.Capability_None, protocol.TaskKind_Oneshot, "")
...
func TestResumeRejectsUnknown(t *testing.T) {
	tasks := NewTaskStore()
	_, err := tasks.Resume("00000000000000000000000000000000", "x", nil, protocol.RunnerSelector{}, "", protocol.ClientKind_Unspecified, false, protocol.Capability_None, protocol.TaskKind_Oneshot, "")
