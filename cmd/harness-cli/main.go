...
func agentUsage() {
	...
	fmt.Fprintln(os.Stderr, "                                       block for a matching message (scripting; NOT from an agent turn)")
	...
	fmt.Fprintln(os.Stderr, "                                       send, then block for the reply to THAT message, on your own")
	fmt.Fprintln(os.Stderr, "                                       chat.<short-id> (scripting; NOT from an agent turn)")
