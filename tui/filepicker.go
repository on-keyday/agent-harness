...
func DoListFilesFor(c *cli.Client, taskID, relPath string) tea.Cmd {
	return func() tea.Msg {
		...
		defer cancel()
		entries, err := c.ListFiles(ctx, taskID, relPath, protocol.DataPlaneRoute_Splice)
...
func (m FilePickerModel) handleNewDirKey(k tea.KeyMsg) (FilePickerModel, tea.Cmd) {
	...
	case tea.KeyEnter:
		...
		m.input.Blur()
		m.msg = "creating " + rel + "..."
		return m, DoFileMkdir(m.client, m.taskID, rel, true, protocol.DataPlaneRoute_Splice)
	}
	var cmd tea.Cmd
...
func (m FilePickerModel) commitInputPath(path string) (FilePickerModel, tea.Cmd) {
	...
	case pickerAskPushSrc:
		...
		return m, DoFilePush(m.client, m.taskID, path, dest, recursive, false, false, protocol.DataPlaneRoute_Splice)
	case pickerAskPullDst:
		...
		m.inputMode = pickerNone
		m.localBrowseActive = false
		return m, DoFilePull(m.client, m.taskID, src, path, recursive, true, protocol.DataPlaneRoute_Splice, cli.FileTransferRange{})
	}
	return m, nil
}
...
func (m FilePickerModel) handleConfirmKey(k tea.KeyMsg) (FilePickerModel, tea.Cmd) {
	...
	case "y", "Y":
		...
		m.inputMode = returnMode
		return m, DoFileDelete(m.client, m.taskID, joinRel(m.curDir, target), rec, force, protocol.DataPlaneRoute_Splice)
...
func (m FilePickerModel) handlePushOverwriteKey(k tea.KeyMsg) (FilePickerModel, tea.Cmd) {
	...
	case "y", "Y":
		...
		m.pendingPushRecursive = false
		m.inputMode = pickerNone
		return m, DoFilePush(m.client, m.taskID, local, remote, rec, true, false, protocol.DataPlaneRoute_Splice)
	case "n", "N", "esc":
		m.pendingPushLocal = ""
		m.pendingPushRemote = ""
		m.pendingPushRecursive = false
...
func (m FilePickerModel) handlePullOverwriteKey(k tea.KeyMsg) (FilePickerModel, tea.Cmd) {
	...
	case "y", "Y":
		...
		m.inputMode = pickerNone
		m.localBrowseActive = false
		return m, DoFilePull(m.client, m.taskID, src, dst, rec, true, protocol.DataPlaneRoute_Splice, cli.FileTransferRange{})
	case "n", "N", "esc":
		m.pendingPullSrc = ""
		m.pendingPullDst = ""
		m.pendingPullRecursive = false
